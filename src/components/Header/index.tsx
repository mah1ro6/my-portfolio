  ...
  return (
    <div
      className={
        history.location.pathname === '/'
          ? 'flex flex-col justify-around items-center absolute top-1/4 bg-opacity-0 w-full h-3/5'
    ...
    >
      <h1
        ...
        className={
          history.location.pathname === '/'
            ? 'text-gray-600 font-extralight tracking-widest text-center text-6xl sm:text-4xl'
